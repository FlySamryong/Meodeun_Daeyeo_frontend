...
class DateTimeFormatter {
  ...
  static String formatToKoreanDateTime(String dateTimeString) {
    ...
    return DateFormat("yyyy년 MM월 dd일 HH시 mm분").format(parsedDateTime);
  }

  /// 서버에서 받은 날짜 문자열을 한국 시간대로 변환하고
  /// "yyyy년 MM월 dd일" 형식으로 포맷합니다.
  static String formatToKoreanDate(DateTime dateTime) {
    return DateFormat("yyyy년 MM월 dd일").format(dateTime);
  }

  /// "HH:mm" 형식으로 시간만 포맷합니다.
